                ...
                <div className="blog agency pricing inner-pagetitle pt-4 pt-lg-0">
                    <div className="price-container price-margin shadows bg-white text-left mb-sm-0">
                        <div className="price-feature-container set-relative text-center text-lg-left">
                            ...
                            <h3 className="feature-text-heading text-center text-lg-left pb-3">Envío incluido a todo Colombia</h3>
                            <div className="price-value mb-3">
                                <div className="price text-center text-lg-left">$<span className="large">150.000</span></div>
                            </div>
                            <a className="btn btn-default btn-white purchase-kit" target="_blank" href="https://checkout.wompi.co/l/XyjluW">Comprar</a>
                            <div className="font-primary pt-3">
                                <h3 className="feature-text-heading text-center text-lg-left bold pb-2" style={{ marginTop: '1rem' }}>Descripción</h3>
                                <p className="price-feature text-justify">
                                    Incluye 3 plantillas personalizables: elige desde nuestro catálogo de 30 diseños o envíanos los tuyos,
